...
class CollectionService:
    ...
    def run_pipeline(db: Session, brand_id: int = 1, source: str = "all", limit_per_source: int = 30) -> List[CollectionRun]:
        ...
        LOCAL SENTIMENT -> ENGAGEMENT & VIRALITY -> BATCH OPENAI -> DATABASE
        """
        ...
        for collector in collectors:
            ...
            try:
                ...
                for raw in raw_posts:
                    ...
                    # Filter for OpenAI: viral posts, mixed sentiment, or high engagement posts
                    posts_for_ai.append({
                        "id": post.id,
                        "title": post.title,
                ...
                for item_dict in posts_for_ai:
                    ...
                    analysis = PostAnalysis(
                        ...
                        topic=ai_item.topic if ai_item else "General Chatter",
                        ...
                        summary=ai_item.summary if ai_item else "Discussion about brand products and performance.",
                        recommendation=ai_item.recommendation if ai_item else "Continue monitoring product feedback.",
                        virality_score=item_dict["virality_score"],
                        virality_level=item_dict["virality_level"],
                        is_viral=item_dict["is_viral"],
                        analysis_version="1.0",
                        model_used=ai_service.active_model_name
                    )
                    db.add(analysis)
